    ...
    <div class="container-fluid animated">
        <div class="row">
            <div class="mb-3 ml-2 mt-6 col-md-10">
                    <h2 class="step_title">Introduction</h2>
                    <h3>What is AGILITY?</h3>
                    <p class="descParagrah">It is an organisational philosophy for facing uncertainty in the business environment of the firm through continuous adaptation, transformation and improvement.                           
                        </p><hr>
                     ...
                     <p class="descParagrah">
                         <ul class="descParagrah">
                             <li>Identify the areas in the firm that need attention and work</li>
                             <li>Identify potential solutions, giving you ideas for considering in the company’s plans</li>
                         </ul>
                         <p class="descParagrah">
