      ...
      <div class="ProductLines">
          <div class="container-fluid">
              <div class="row">
                  ...
                  <input type="hidden" value="{{ (isset($leaderships) && count($leaderships)>0)? count($leaderships) : 11 }}" id="count">
                  <table class="table table-striped step3Table col-md-7" id="example">
                      ...
                      <tbody>
                          <div class="field">
                              @if(!isset($leaderships) || count($leaderships)==0))
                              ...
                              @else
                               @for($i=0;$i<count($leaderships);$i++)
                               <tr id="{{'field'.($i+1)}}" class="leadership_row">
                                    <th scope="row" class="tableH factors">
                                    <textarea type="text" rows="3" cols="20" class="form-control market_textarea" name="{{'factor'.($i+1)}}">{{$leaderships[$i]->question}}</textarea>
                                    </th>
                                    <td><select name="{{'x'.($i+1)}}" class="dataset" dataset="0">
        
                                        <option value="1" {{ ($leaderships[$i]->attractiveness==1)? "selected=selected" : "" }}>1</option>
                                        <option value="2" {{ ($leaderships[$i]->attractiveness==2)? "selected=selected" : "" }}>2</option>
                                        <option value="3" {{ ($leaderships[$i]->attractiveness==3)? "selected=selected" : "" }}>3</option>
                                        <option value="4" {{ ($leaderships[$i]->attractiveness==4)? "selected=selected" : "" }}>4</option>
                                        <option value="5" {{ ($leaderships[$i]->attractiveness==5)? "selected=selected" : "" }}>5</option>
                                    </select></td>
                                    <td><select name="{{'y'.($i+1)}}" class="dataset" dataset="1">
                                            <option value="1" {{ ($leaderships[$i]->sector==1)? "selected=selected" : "" }}>1</option>
                                            <option value="2" {{ ($leaderships[$i]->sector==2)? "selected=selected" : "" }}>2</option>
                                            <option value="3" {{ ($leaderships[$i]->sector==3)? "selected=selected" : "" }}>3</option>
                                            <option value="4" {{ ($leaderships[$i]->sector==4)? "selected=selected" : "" }}>4</option>
                                            <option value="5" {{ ($leaderships[$i]->sector==5)? "selected=selected" : "" }}>5</option>
                                    </select></td>
                                    <td><select name="{{'z'.($i+1)}}" class="dataset" dataset="2">
        
                                        <option value="5" {{ ($leaderships[$i]->mainting==5)? "selected=selected" : "" }}>5</option>
                                        <option value="4" {{ ($leaderships[$i]->mainting==4)? "selected=selected" : "" }}>4</option>
                                        <option value="3" {{ ($leaderships[$i]->mainting==3)? "selected=selected" : "" }}>3</option>
                                        <option value="2" {{ ($leaderships[$i]->mainting==2)? "selected=selected" : "" }}>2</option>
                                        <option value="1" {{ ($leaderships[$i]->mainting==1)? "selected=selected" : "" }}>1</option>
                                    </select></td>
                                    <td><select name="{{'k'.($i+1)}}" class="dataset" dataset="3">
        
                                        <option value="1" {{ ($leaderships[$i]->position==1)? "selected=selected" : "" }}>1</option>
                                        <option value="2" {{ ($leaderships[$i]->position==2)? "selected=selected" : "" }}>2</option>
        
                                    </select></td>
                                    <td scope="row" class="tableH">
                                        <textarea type="text" class="form-control dynamicArea comments" name="comment1" onfocus="createTooltip(this)" onkeyup="theFocus(this);" onchange="theBlur()" title="">
                                         {{$leaderships[$i]->comment}}
                                        </textarea>
    
                                    </td>
    
                                    <td id='delete-td1'>
                                        <button id="{{'remove'.($i+1)}}" class="btn" onclick="deleteRow(this,{{$i+1}})">delete</button>
                                    </td>
